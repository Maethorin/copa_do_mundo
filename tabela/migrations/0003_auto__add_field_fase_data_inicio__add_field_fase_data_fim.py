...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fase.data_inicio'
        db.add_column('fases', 'data_inicio',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Fase.data_fim'
        db.add_column('fases', 'data_fim',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fase.data_inicio'
        db.delete_column('fases', 'data_inicio')

        # Deleting field 'Fase.data_fim'
        db.delete_column('fases', 'data_fim')
