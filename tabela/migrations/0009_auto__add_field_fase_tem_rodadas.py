...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fase.tem_rodadas'
        db.add_column('fases', 'tem_rodadas',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fase.tem_rodadas'
        db.delete_column('fases', 'tem_rodadas')
    ...
    models = {
        ...
        u'tabela.fase': {
            ...
            'tem_rodadas': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'tabela.grupo': {
