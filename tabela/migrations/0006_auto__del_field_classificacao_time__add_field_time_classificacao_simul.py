...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Classificacao.time'
        db.delete_column('classificacao', 'time_id')

        # Adding field 'Time.classificacao_simulada'
        db.add_column('times', 'classificacao_simulada',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tabela.Classificacao'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Classificacao.time'
        db.add_column('classificacao', 'time',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tabela.Time'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Time.classificacao_simulada'
        db.delete_column('times', 'classificacao_simulada_id')
    ...
    models = {
        ...
        u'tabela.time': {
            ...
            'classificacao_simulada': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tabela.Classificacao']", 'unique': 'True', 'null': 'True'}),
            'empates': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'gols_feitos': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'gols_tomados': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
